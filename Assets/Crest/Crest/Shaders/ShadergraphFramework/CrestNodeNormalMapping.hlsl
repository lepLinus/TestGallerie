...
#if _FLOW_ON
	ApplyNormalMapsWithFlow(i_positionXZWSUndisplaced, i_flow, input.lodAlpha_worldXZUndisplaced_oceanDepth.x, n_pixel);
#else
	n_pixel.xz += (underwater ? -1.0 : 1.0) * SampleNormalMaps(i_positionXZWSUndisplaced, i_normals, i_normalsScale, i_normalsStrength, i_lodAlpha);
