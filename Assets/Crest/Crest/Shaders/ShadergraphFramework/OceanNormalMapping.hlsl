...
//void ApplyNormalMapsWithFlow(float2 worldXZUndisplaced, half i_normalsScale, float2 flow, float lodAlpha, inout half3 io_n)
//{
...
//	half2 io_n_1 = SampleNormalMaps(worldXZUndisplaced - (flow * sample1_offset), i_normalsScale, lodAlpha);
//	half2 io_n_2 = SampleNormalMaps(worldXZUndisplaced - (flow * sample2_offset), i_normalsScale, lodAlpha);
