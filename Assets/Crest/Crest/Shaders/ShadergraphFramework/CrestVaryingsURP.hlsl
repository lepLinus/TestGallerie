...
Varyings BuildVaryings(Attributes input)
{
    ...
    // Crest -------------------
    output.LodAlpha = vertexDescription.LodAlpha;
    output.WorldXZUndisplaced = vertexDescription.WorldXZUndisplaced;
    output.OceanDepth = vertexDescription.OceanDepth;
    output.Foam = vertexDescription.Foam;
    output.Shadow = vertexDescription.Shadow;
    output.Flow = vertexDescription.Flow;
    output.SSS = vertexDescription.SSS;
    // -------------------------
